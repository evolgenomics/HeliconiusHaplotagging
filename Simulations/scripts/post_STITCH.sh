...
cd $folder;
../../scripts/add_PL.sh stitch.Herato1603.450000.550000.vcf.gz
bcftools reheader -s ../../sourceData/sample.names stitch.Herato1603.450000.550000.PL.vcf.gz > stitch.Herato1603.450000.550000.PL.reheadered.vcf.gz
bcftools index stitch.Herato1603.450000.550000.PL.reheadered.vcf.gz;
perl ../../scripts/check_truth_ARG.pl $tag
mkdir tmp;


#for i in `seq 0 2 967`; do echo "HAPCUT - $i"; ../hapcutVcf.helera1_demo.sh hap_$i.linkedReads.diploid.$tag.bam stitch.Herato1603.450000.550000.PL.reheadered.vcf.gz $tag; done
